...
const ActivePath = () => (
    <>
        <rect strokeWidth={3} fill="var(--chakra-colors-iconColors-primary)" x="126.44" y="105.27" width="17.23" height="164.72" transform="translate(322.69 52.57) rotate(90)"/>
        <rect strokeWidth={3} fill="var(--chakra-colors-iconColors-primary)" x="126.44" y="50.13" width="17.23" height="164.72" transform="translate(267.56 -2.56) rotate(90)"/>
        <rect strokeWidth={3} fill="var(--chakra-colors-iconColors-primary)" x="126.44" y="-5" width="17.23" height="164.72" transform="translate(212.42 -57.7) rotate(90)"/>
    </>
);
